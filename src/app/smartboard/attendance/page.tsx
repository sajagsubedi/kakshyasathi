...
export default function SmartBoardAttendancePage() {
  ...
  return (
    <DashboardLayout items={smartBoardNav} title="Kakshyasathi" subtitle="Smart Board" pageTitle="Attendance" pageDescription="Barcode scanning station" allowedRoles={['SMARTBOARD']}>
