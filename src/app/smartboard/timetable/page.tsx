...
export default function SmartBoardTimetablePage() {
  ...
  return (
    <DashboardLayout items={smartBoardNav} title="Kakshyasathi" subtitle="Smart Board" pageTitle="Timetable" pageDescription="Effective classroom schedule for today" allowedRoles={['SMARTBOARD']}>
