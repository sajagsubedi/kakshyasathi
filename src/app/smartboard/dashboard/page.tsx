...
export default function SmartBoardDashboard() {
  ...
  return (
    <DashboardLayout items={smartBoardNav} title="Kakshyasathi" subtitle="Smart Board" pageTitle={user?.deviceId ?? 'Smart Board'} pageDescription={classroom?.sectionName ?? 'Classroom display'} allowedRoles={['SMARTBOARD']}>
